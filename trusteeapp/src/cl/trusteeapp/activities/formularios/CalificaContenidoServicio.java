package cl.trusteeapp.activities.formularios;
...
import cl.trusteeapp.activities.notifications.NotificarDiezValidaciones;
...
public class CalificaContenidoServicio extends ABaseActivity {
    ...
    btnCalificaSend.setOnClickListener(new OnClickListener() {
      ...
      public void onClick(View v) {
        ...
        SharedPreferences preferences =
            PreferenceManager.getDefaultSharedPreferences(CalificaContenidoServicio.this);
        ...
        if (sendFeedback % 10 == 0) {
          Intent mIntent =
              new Intent(CalificaContenidoServicio.this, NotificarDiezValidaciones.class);
  ...
  private class FeedbackTask extends AsyncTask<Void, Void, Boolean> {
    ...
    protected void onPostExecute(Boolean result) {
      if (result)
        Toast.makeText(CalificaContenidoServicio.this, "Gracias por enviar calificación.",
            Toast.LENGTH_SHORT).show();
    }

    @Override
    protected void onCancelled() {
      Toast.makeText(CalificaContenidoServicio.this, "Tarea cancelada!", Toast.LENGTH_SHORT).show();
    }
  }
}
