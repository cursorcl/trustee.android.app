package cl.trustee.activities.config;
...
import cl.trustee.R;
import cl.trustee.activities.ABasePreferenceActivity;
import cl.trustee.activities.system.SetupTrustee;
...
//					params.add(new BasicNameValuePair("device", getDeviceName()));
					...
					Intent intent = new Intent(FormularioRegistroUsuario.this,
							SetupTrustee.class);
	...
	protected void onResume() {
		...
		email.setSummary("Correo electrónico:"
	...
	private void notifyErrorMailError(String text) {
		Toast toast = Toast.makeText(this,
				String.format("Correo electrónico %s inválido.", text),
				Toast.LENGTH_SHORT);
